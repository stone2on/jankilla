...
using Jankilla.Core.DB.Repositories;
using System;
...
USE [master]
GO
/****** Object:  Database [OTC.Management]    Script Date: 2024-06-12 오후 3:20:14 ******/
CREATE DATABASE [OTC.Management]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OTC.Management', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\OTC.Management.mdf' , SIZE = 22528KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'OTC.Management_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.SQLEXPRESS\MSSQL\DATA\OTC.Management_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [OTC.Management] SET COMPATIBILITY_LEVEL = 120
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [OTC.Management].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [OTC.Management] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [OTC.Management] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [OTC.Management] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [OTC.Management] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [OTC.Management] SET ARITHABORT OFF 
GO
ALTER DATABASE [OTC.Management] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [OTC.Management] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [OTC.Management] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [OTC.Management] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [OTC.Management] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [OTC.Management] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [OTC.Management] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [OTC.Management] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [OTC.Management] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [OTC.Management] SET  DISABLE_BROKER 
GO
ALTER DATABASE [OTC.Management] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [OTC.Management] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [OTC.Management] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [OTC.Management] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [OTC.Management] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [OTC.Management] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [OTC.Management] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [OTC.Management] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [OTC.Management] SET  MULTI_USER 
GO
ALTER DATABASE [OTC.Management] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [OTC.Management] SET DB_CHAINING OFF 
GO
ALTER DATABASE [OTC.Management] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [OTC.Management] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [OTC.Management] SET DELAYED_DURABILITY = DISABLED 
GO
USE [OTC.Management]
GO
/****** Object:  User [otc]    Script Date: 2024-06-12 오후 3:20:14 ******/
CREATE USER [otc] FOR LOGIN [otc] WITH DEFAULT_SCHEMA=[dbo]
GO
ALTER ROLE [db_datareader] ADD MEMBER [otc]
GO
ALTER ROLE [db_datawriter] ADD MEMBER [otc]
GO
/****** Object:  Table [dbo].[Blocks]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[BooleanTags]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Devices]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Drivers]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MitsubishiMxComponentBlocks]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MitsubishiMxComponentDevices]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MitsubishiMxComponentDrivers]    Script Date: 2024-06-12 오후 3:20:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
