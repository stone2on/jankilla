    ...
    public class LongTag : Tag
    {
        ...
        public override object Value
        {
            ...
            protected set
            {
                ...
                double calibratedVal = LongValue;
                if (UseFactor)
                {
        ...
        public override ETagDiscriminator Discriminator => ETagDiscriminator.Long;
        ...
        public override void Read(short[] buffer, int startIndex)
        {
            ...
            this.Value = BitConverter.ToInt64(byteBuffer, 0);
        }
        ...
        public override void Read(byte[] buffer, int startIndex)
        {
            ...
            this.Copy(buffer, startIndex);
            this.Value = BitConverter.ToInt64(buffer, startIndex);
        }
